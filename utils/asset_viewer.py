object_path = "data/home-robot-data/data/objects/train_val/ai2thorhab/assets/objects/Book_22.glb"
# ---
# jupyter:
#   accelerator: GPU
#   colab:
...
# fmt: off
output_directory = "/home/yue/桌面/asset_videos/"  # @param {type:"string"}
# fmt: on
...
def make_simulator_from_settings(sim_settings):
    ...
    sel_file_obj_handle = obj_attr_mgr.get_file_template_handles()
...
# fmt: off
object_to_view_path = object_path  # @param {type:"string"}
# fmt: on
