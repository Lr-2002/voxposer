...
from voxposer.utils_main import DynamicObservation, IterableDynamicObservation, load_prompt
from voxposer.GPT.call_LM import GPT
    ...
    def _cached_api_call(self, **kwargs):
        ...
        if kwargs['model'] != 'gpt-3.5-turbo-instruct' and \
            ...
            if kwargs in self._cache:
                ...
                ret = self.chat_tool._call_lm(message, model='gpt-4o-2024-08-06')
                # post processing
