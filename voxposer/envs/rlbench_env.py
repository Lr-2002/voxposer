...
class VoxPoserRLBench():
    def __init__(self, visualizer=None):
        ...
        self.rlbench_env = Environment(action_mode, obs_config=obs_config)
    ...
    def get_3d_obs_by_name(self, query_name):
        ...
        for cam in self.camera_names:
            ...
            pcd.points = o3d.utility.Vector3dVector(np.array(points[-1].tolist()))
    ...
    def get_scene_3d_obs(self, ignore_robot=False, ignore_grasped_obj=False):
        ...
        # print(colors.astype(np.float32) / 255.0)
        pcd.colors = o3d.utility.Vector3dVector(np.array((colors.astype(np.float32)/255.0).tolist()))
        # print('hello world')
        pcd_downsampled = pcd.voxel_down_sample(voxel_size=0.001)
